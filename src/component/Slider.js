...
Welcome.defaultProps = {
  illustrations: [
    { id: 1, source: require('../../assets/illustration_1.png') },
    { id: 2, source: require('../../assets/illustration_2.png') },
    { id: 3, source: require('../../assets/illustration_3.png') },
  ],
};
